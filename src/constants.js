...
// 契約更改交渉 (NPB年俸交渉モデル)
export const MAX_SALARY_CUT_RATIO           = 0.40;  // NPB協約: 球団の減額制限40%
export const MIN_OFFER_RATIO                = 0.60;  // 球団が提示できる最低額 = 前年俸×0.60
export const CPU_RENEWAL_ROUNDS             = 3;     // CPU交渉の最大ラウンド数
export const CPU_TEAM_OFFER_HIGH_TV_RAISE   = 0.12;  // tradeValue≥70 の初回提示増額率
export const CPU_TEAM_OFFER_MID_TV_RAISE    = 0.05;  // tradeValue50-69
export const CPU_TEAM_OFFER_LOW_TV_RAISE    = 0.00;  // tradeValue<50 はフラット提示
export const CPU_TEAM_ROUND2_GAP_CLOSE      = 0.50;  // 2ラウンド目: 乖離の50%を埋める
export const CPU_TEAM_ROUND3_GAP_CLOSE      = 0.90;  // 3ラウンド目: 乖離の90%まで歩み寄る
export const PLAYER_DEMAND_RAISE_ELITE      = 0.30;  // エリートシーズン → 要求+30%以上
export const PLAYER_DEMAND_RAISE_GOOD       = 0.25;  // 好シーズン → 要求+25%
export const PLAYER_DEMAND_RAISE_OK         = 0.10;  // 並シーズン → 要求+10%
export const PLAYER_DEMAND_MONEY_EXTRA      = 0.15;  // personality.money>70 の追加要求
export const PLAYER_RESISTANCE_HIGH_MORALE  = 80;    // この値以上で選手の抵抗係数↑
export const PLAYER_RESISTANCE_LOW_MORALE   = 40;    // この値以下で選手の抵抗係数↓
export const NEGOTIATION_MORALE_ACCEPT_BONUS   = 5;  // 要求額以上で合意 → morale+5
export const NEGOTIATION_MORALE_CUT_PENALTY    = -10; // 10%超減額で合意 → morale-10
export const NEGOTIATION_MORALE_FORCE_PENALTY  = -12; // 強制最低額サイン → morale-12
export const NEGOTIATION_MORALE_ROUND_HIT      = -3;  // 2ラウンド目以降 1回ごと morale-3
export const NEGOTIATION_TRUST_HAPPY           = 3;   // 1ラウンド合意 → trust+3
export const NEGOTIATION_TRUST_HOLDOUT         = -2;  // 複数ラウンド経由 → trust-2
export const NEGOTIATION_TRUST_RELEASED        = -5;  // リリース/FA宣言 → trust-5
