...
/* ═══════════════════════════════════════════════
   BATCH RESULT SCREEN
═══════════════════════════════════════════════ */
export function BatchResultScreen({ results, batchMeta, myTeam, onEnd }) {
  ...
  const innings = selGame
    ? Array.from({ length: Math.max(9, (selGame.inningSummary || []).reduce((m, s) => Math.max(m, s.inning), 9)) }, (_, i) => i + 1)
    : [];
