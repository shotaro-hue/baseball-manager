...
import { getAllStarGameDay, getMyMatchup } from '../../engine/scheduleGen';
...
export function ScheduleTab({ schedule, gameDay, myTeam, teams, year, gameResultsMap = {}, allStarDone = false }) {
  ...
  const allStarGameDay = useMemo(() => getAllStarGameDay(year, schedule), [year, schedule]);
    ...
    <div style={{ display: 'grid', gap: 12 }}>
      ...
      <div className="card" style={{ background: 'rgba(245,200,66,.06)' }}>
        ...
        <div style={{ fontSize: 12, color: '#cbd5e1' }}>
          第{allStarGameDay}戦 ({formatDate(gameDayToDate(allStarGameDay, schedule))}) に開催
